...
namespace INSTINCT_RETRIEVAL_NS {
    ...
    TEST_F(DuckDBVectorStoreTest, make_search_sql) {
        ...
        auto sql = details::make_search_sql("tb1", s1, instinct::test::make_zero_vector(), mq);
        std::cout << sql << std::endl;
        ...
        sql = details::make_search_sql("tb1", s1, instinct::test::make_zero_vector(), MetadataQuery {});
        std::cout << sql << std::endl;
