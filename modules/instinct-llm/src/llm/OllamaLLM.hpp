...
namespace INSTINCT_LLM_NS {
    ...
    public:
        ...
        explicit OllamaLLM(INSTINCT_CORE_NS::Endpoint endpoint);
    ...
    inline OllamaLLM::OllamaLLM(INSTINCT_CORE_NS::Endpoint endpoint): BaseLLM(), http_client_(std::move(endpoint)) {
    }
