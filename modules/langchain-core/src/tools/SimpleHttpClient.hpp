...
#include "HttpChunkBodyIterator.hpp"
...
LC_CORE_NS {
    ...
    inline SimpleHttpClient::SimpleHttpClient(Endpoint endpoint, HttpClientOptions options): ioc_(), endpoint_(std::move(endpoint)), options_(options), resolve_results_() {
    ...
    inline HttpResponsePtr SimpleHttpClient::Execute(const HttpRequest& call) {
    ...
    inline HttpChunkBodyIteratorPtr SimpleHttpClient::Stream(const HttpRequest& call) {
